...
import /* supabase, getStorageURL */ "../lib/supabase";
      ...
      <div>
        <div className="profileData">
          <div>
            ...
            {/* false && <p>Angelegt: {new Date(user?.created_at!).toLocaleDateString()}</p>
            false && <p>Zuletzt geändert: {new Date(user?.updated_at!).toLocaleDateString)}</p>
            false && <p>letzte Anmeldung: {new Date(user?.last_sign_in_at!).toLocaleDateString()}</p> */}
          </div>
          <div>
